...
import org.pdfcreator.service.POIExcelToHtmlService;
...
import java.util.*;
@Service
public class POIExcelToHtmlServiceImpl implements POIExcelToHtmlService {
    private static final Logger logger = LoggerFactory.getLogger(POIExcelToHtmlServiceImpl.class);
    @Override
    public void excelToHtml(String sourcePath, String targetPath, boolean isWithStyle) {
        InputStream is = null;
        ...
        try {
            ...
            if (wb instanceof XSSFWorkbook) {
                ...
                PdfFilesUtils.writeFile(htmlExcel, targetPath);
    ...
    @Override
    public void excelToHtml(String sourcePath, String targetPath) {
        this.excelToHtml(sourcePath, targetPath, true);
    }
     ...
     * * @param sb 256
     */
    private void dealExcelStyle(Workbook wb, Sheet sheet, Cell cell, StringBuilder sb) {
        ...
        if (cellStyle != null) {
            ...
            if (wb instanceof XSSFWorkbook) {
                ...
                sb.append("style=\"");
                sb.append("font-family:" + "'"+ xf.getFamily() +"';");//字体
                ...
                sb.append("font-family:" + "'"+ HSSFFont.FONT_ARIAL +"';");//字体
                sb.append("font-weight:" + boldWeight + ";"); // 字体加粗
    ...
    private static String[] borderStyles = { "solid ", "solid ", "solid ", "solid ", "solid ", "solid ", "solid ", "solid ",
    ...
    private Map<String, List<HSSFPictureData>> findAllPictureDate(HSSFSheet sheet){
