...
public class POIExcelToHtml {
	...
	public static void excelToHtml(String SourcePath,String targetPath , boolean isWithStyle) {
	...
	private static String getExcelInfo(Workbook wb, boolean isWithStyle) {
		...
		sb.append("<html lang=\"zh-cn\"><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\">");
	...
	private static Map<String, List<HSSFPictureData>> findAllPictureDate(HSSFSheet sheet){
