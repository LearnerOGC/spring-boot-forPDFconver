...
public class POIReadExcel {
     ...
     */
    public static void excelToHtml(String sourcePath, String targetDir){
        File sourceFile = new File(sourcePath);
        try {
            InputStream fis = new FileInputStream(sourceFile);
            String excelHtml = POIReadExcel.readExcelToHtml(fis, true);
            FileUtils.writeFile(excelHtml, targetDir);
    ...
    public static void printImg(Map<String, PictureData> map) throws IOException {
        ...
        for (int i = 0; i < map.size(); i++) {
            ...
            FileOutputStream out = new FileOutputStream("C:\\D_files\\poi\\html\\pic" + picName + "." + ext);
            out.write(data);
            out.flush();
            out.close();
        }
